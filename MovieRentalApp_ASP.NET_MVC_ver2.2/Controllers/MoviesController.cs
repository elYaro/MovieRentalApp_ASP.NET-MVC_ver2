...
using MovieRentalApp_ASP.NET_MVC_ver2._2.ViewModels;
using System;
...
namespace MovieRentalApp_ASP.NET_MVC_ver2._2.Controllers
{
    public class MoviesController : Controller
    {
        ...
        We can use the old scool way: routes.MapRoute() or the new way routes.MapMvcAttributeRoutes(). Both are presented in RoutesConfig.cs
        If we want to do it in modern way ba usinf roures.MapMVCAttribureRoutes we must add here annotation ex. [Route("movies/released/{year}/{month}")] or we can additionally add constraints like below
